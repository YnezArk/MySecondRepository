	...
	public static void main(String[] args) {
		...
		bbc.addListener(new Listener() {
			...
			public void newsArrived(NewsEvent e) {
				System.out.println("匿名类：please note," + e.text + " happend，级别=" + e.level);
			}
		});

		/*2. Lambda 订阅者*/
		bbc.addListener(e -> System.out.println("Lambda:please note," + e.text + " happend，级别=" + e.level));
